...
Tablet::Tablet(const std::string& brand, float screensize, int ram, int battery_life, bool has_stylus)
    : Portable_computer(brand, screensize, ram, battery_life), has_stylus(has_stylus) {}
